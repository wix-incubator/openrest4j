...
public class FixedAmountPerItemAction extends Action {
    public static final String TYPE = "fixed_per_item";
    private static final long serialVersionUID = 1L;
    
    /** Default constructor for JSON deserialization. */
    public FixedAmountPerItemAction() {}
    
    public FixedAmountPerItemAction(Integer amount, IdsFilter items, IdsFilter charges, Map<String, String> properties) {
    	super(properties);
    	this.amount = amount;
    	this.items = items;
