...
public class CardInfo implements Serializable, Cloneable {
    ...
    public static final String GATEWAY_HPS = "com.heartlandpaymentsystems";
    ...
    public static final String GATEWAY_MES = "com.merchante-solutions";
    ...
    public static final Set<String> ALL_GATEWAYS = new LinkedHashSet<String>(Arrays.asList(
    		...
    		GATEWAY_FIRSTDATA, GATEWAY_HPS, GATEWAY_ZCREDIT, GATEWAY_PAYPAL, GATEWAY_STRIPE, GATEWAY_PAYSCAPE,
    		GATEWAY_MES));
